...
public class WhiteboardFrame extends JFrame {
	...
	public class ShapeListTableModel extends AbstractTableModel
	{
		 ...
		 * 
		 */
		private static final long serialVersionUID = -6857223234702563919L;
		...
		public ShapeListTableModel() {
			...
			//listen for xz 
			canvas.addShapeListListener(new Canvas.ShapeListListener() {
	...
	protected void initializeControlListeners()
	{
		...
		canvas.addSelectionChangeListener(new Canvas.SelectionChangeListener() {
		...
		startServerButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				try {
					if (performConnect)
					{
						networkServer = new Server(canvas, port);
		...
		startClientButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				try {
					if (performConnect)
					{
						networkClient = new Client(canvas, host, port);
